...
def draw_plot(data_lumi, final_hists, feature, hist_cfg, outdir, base_cut="", extra_cut="", title=""):
    ...
    ratio_frame.GetXaxis().SetNdivisions(510, True)
...
hist_info = {
    ...
    "density_sndsw_scifi": (5000, 11000, 0.4e5, "Sum of SciFi Density Weight (SNDSW)", False, ""),
    # "density_sndsw_scifi": (1000, 400, 4e4, "Sum of SciFi Density Weight (SNDSW)", True),
    "count_scifi":   (10, 0, 800, "SciFi Hit Total Count", True, ""),
    "count_scifi1":   (1, 0, 50, "Plane1 SciFi Hit Total Count", True, ""),
    "count_scifi2":   (1, 0, 50, "Plane2 SciFi Hit Total Count", True, ""),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--extra_cut",
        default="density_scifi > 1000 ", #count_scifi>200 density_scifi > 1000 density_sndsw_scifi_second > 20 

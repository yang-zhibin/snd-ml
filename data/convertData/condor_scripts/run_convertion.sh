...
do
    ...
    python /afs/cern.ch/user/z/zhibin/work/snd-ml/data/convertData/convert_rawData.py -r ${input_file} -g ${geo_file} -m ./${tmp_dir}/${muon_out_file} -s1 ./${tmp_dir}/filtered_MC_00${i_run}_stage1.root -s2 ./${tmp_dir}/filtered_MC_00${i_run}_stage2.root -o ./${tmp_dir}/${base_name}_converted_00${i_run}.root -p ${i_run} 

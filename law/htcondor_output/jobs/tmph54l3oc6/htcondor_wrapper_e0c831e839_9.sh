...
htcondor_wrapper() {
    ...
    htcondor_job_arguments_map=(
        ['1']="analysis.tasks Digi2Hits LS1sb2ctZmlsZT1OT19TVFIgLS1jbGVhci1sb2dzPUZhbHNlIC0tbWF4LXJ1bnRpbWU9MDE6MDA6MDA= MQ== 1 no LQ=="
        ['2']="analysis.tasks Digi2Hits LS1sb2ctZmlsZT1OT19TVFIgLS1jbGVhci1sb2dzPUZhbHNlIC0tbWF4LXJ1bnRpbWU9MDE6MDA6MDA= Mg== 1 no LQ=="
    )
    ...
    # check variables
    local render_variables=""

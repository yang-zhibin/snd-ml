...
hist_info = {
    "density_scifi": (1000, 1000, 1e4, "Sum of SciFi Density Weight", False),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cut",
        default="count_scifi>200 && consecutiveSciFiHits == 1 && SciFiContinuity==1 && SciFiHit35==1 && NoHitLastDS == 1", #count_scifi>200

...
# tree.Print()
raw_data, raw_tree = open_root_file("/afs/.cern.ch/user/s/sfrankha/eos/sndlhc/convertedData/commissioning/testbeam_24/run_100881/feature_sndsw_raw-0000.root", tree_name='sndData')
print(raw_tree.GetListOfBranches())
for br in raw_tree.GetListOfBranches():
    print(br.GetName())
...
#         print(f"Hit orientation: {hit.orientation}")
#     # --- SciFi hits ---
    # print(event.Hits)
